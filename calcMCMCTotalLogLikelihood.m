...
pSZHfc_age3 = x0(16);
                             ...
                             pH_HKUSZH_dh = 0;
                             pH_HKUSZH_fc = 0;
                             a_all = 0.92;  % Fixed parameter - do not modify
                             b_all = 0.75;  % Fixed parameter - do not modify
...
% Function to calculate the total log-likelihood value for given parameters.
% This function is specifically designed for MCMC (Markov Chain Monte Carlo) algorithm,
% where it takes a set of parameters x0 and other necessary inputs to compute
% the total log-likelihood by calling the totalLogLikelihood function.